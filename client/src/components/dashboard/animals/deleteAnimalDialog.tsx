...
function DeleteAnimalDialog({ setDialogShow, confirmDeletion }) {
  return (
    <div className="fixed min-h-screen top-0 left-0 right-0 button-0 w-full bg-gradient-to-b from-amber-100/60 to-orange-300/60 flex justify-center items-center z-40">
        ...
        <div className="w-96  rounded-lg flex">
          ...
          <div className="w-full pt-9 pr-4">
            ...
            <p className="py-4 text-sm text-gray-400">
              Are you sure you want to delete this animal from the records?
